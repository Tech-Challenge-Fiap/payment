import math
import basehash
from system.application.ports.payment_provider_port import PaymentProviderPort
...
class MercadoPago(PaymentProviderPort):
    @classmethod
    ...
    def get_payment_by_id(cls, payment_id):
        ...
        try:
            mocked_payment = {
                ...
                "external_reference": "1a75a0280cdc11ef81681f0dc1076825",
                "collector_id": 2,
                "payer": {
                    "id": 123,
